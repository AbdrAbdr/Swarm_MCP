...
# 🐝 MCP Swarm v1.0.7 — Универсальная Платформа Координации AI-Агентов

> 🌉 **v1.0.7 — Полный Remote Bridge:** Все **26 Smart Tools** теперь работают через Remote Bridge (было 3). Авто-запуск companion с передачей `MCP_SERVER_URL`. Обновитесь: `npm install -g mcp-swarm@latest`
